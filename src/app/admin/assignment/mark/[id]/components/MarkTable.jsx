...
import { useGetAssignmentResultsByIntakeGroupQuery } from '@/lib/features/assignment/assignmentMarkApiSlice';

const IntakeGroupAssignments = ({ id }) => {
  const router = useRouter();
  const { data: assignmentResults, isLoading, isError } = useGetAssignmentResultsByIntakeGroupQuery(id);
...
export default IntakeGroupAssignments;
