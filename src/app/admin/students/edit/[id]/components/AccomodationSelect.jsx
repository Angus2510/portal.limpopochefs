...
function AccommodationSelect({ selectedAccommodation, setSelectedAccommodation, currentAccommodation }) {
  ...
  const selectedAccommodationDetails = currentAccommodation 
    ? currentAccommodation 
    : accommodations.find(accommodation => accommodation.id === selectedAccommodation);
