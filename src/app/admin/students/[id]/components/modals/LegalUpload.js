...
import { useAddNewLegalDocumentMutation } from '@/lib/features/students/studentsDocumentsApiSlice';
import Card from "@/components/card";

const LegalUpload = ({id}) => {
    console.log (id)
  const [addNewLegalDocument, { isLoading, isSuccess, isError, error }] = useAddNewLegalDocumentMutation();
  ...
  return (
    <Card className="bg-white p-6 rounded-lg shadow-lg">
      ...
      <form onSubmit={onAddLegalDocumentClicked} encType="multipart/form-data" className="space-y-4">
        <div>
