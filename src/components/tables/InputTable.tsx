...
type Props = {
  ...
  data: RowData[];
  filters: Filter[];
  onRowClick?: (row: any) => void; // Make onRowClick optional
};

const DataTable: React.FC<Props> = ({ columns, data, filters, onRowClick }) => {
                  ...
                  {row.cells.map((cell, cellIndex) => (
                    ...
                    >
                      {cell.column.id === 'title' ? (
                        <input
                          type="text"
                          value={inputValues[row.original.id] || row.original.title}
